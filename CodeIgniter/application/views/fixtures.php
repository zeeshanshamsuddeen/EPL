...
<div class="kode_wrapper"> 
    ...
    <div class="innner_banner">
        <div class="container">
            ...
            <ul class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="active"><span>fixture</span></li>
            </ul>
        </div>
    </div>
                ...
                <div class="kf_overview_contant">
                    ...
                    <ul class="kf_table2 kf_table4 table-center">
                        ...
                        <?php foreach($fixtures as $fixture) { ?>
                            <li>
                                <div class="tb2_date">
                                    <span><?php echo date("d F, Y", strtotime($fixture->date)); ?></span>
                                </div>
                                <div class="versus">
                                    <div><p>
                                        <b><?php echo $fixture->play_team_1 ?></b>
                                        vs
                                        <b><?php echo $fixture->play_team_2 ?></b>     
                                    </p></div>
                                </div>
                                <div class="tb2_score">
                                    <span><?php echo $fixture->round ?></span>
                                </div>
                                <div class="tb2_status">
                                </div>
                                <div class="tb2_hipoints">
