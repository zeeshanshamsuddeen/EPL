                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-md-offset-3">
                        <div class="kf_form">
                            ...
                            <?php echo form_open('main/contact_us_database'); ?>
                                <div class="input_dec">
                                   NAME : <?php echo form_input('ur_name'); ?>
                                </div>
                                <div class="input_dec">
                                    SUBJECT : <?php echo form_input('ur_subject'); ?>
                                </div>
                                <div class="input_dec">
                                    EMAIL : <?php echo form_input('ur_email'); ?>
                                </div>
                                <div class="input_dec">
                                    COMMENT : <?php echo form_input('ur_area'); ?>
                                </div>
