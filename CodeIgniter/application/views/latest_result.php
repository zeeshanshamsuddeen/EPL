...
<div class="kode_wrapper"> 
    ...
    <div class="innner_banner">
        <div class="container">
            ...
            <ul class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="active"><span>results</span></li>
            </ul>
        </div>
    </div>
            ...
            <div class="container">
                ...
                <div class="kf_overview_contant">
                    ...
                    <ul class="kf_table2 kf_table4 table-center">
                        ...
                        <li>
                            <div class="tb2_date">
                                <span><?php echo date("d F, Y", strtotime($match->date)); ?></span>
                            </div>
                            <div class="versus">
                                <div>
                                <a href="<?php echo site_url('main/scorecard/').$match->match_id ?>">
                                    <?php if($match->win_type == 'DRAW' || $match->win_type == 'draw') { ?>
                                        <p>
                                            <b><?php echo $match->play_team_1 ?></b> vs <b><?php echo $match->play_team_2 ?></b>
                                            ends in a <b>DRAW</b>
                                        </p>
                                        <?php } else { ?>
                                        <p>
                                            <b>
                                                <?php if($match->win_team == $match->play_team_1) 
                                                { echo $match->play_team_1 ?></b> beats <b><?php echo $match->play_team_2; 
                                                } else 
                                                { echo $match->play_team_2 ?></b> beats <b><?php echo $match->play_team_1; } ?> 
                                            </b> 
                                            by <?php echo $match->win_margin ; echo "&nbsp;"; echo $match->win_type ?>
                                        </p>
                                    <?php }  ?>
                                </a>
                                </div>
